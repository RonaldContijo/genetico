...
describe('Step class', () => {
    ...
    it('Should calculate the points for a stable response (s + 2)/(2s + 1)', () => {
        ...
        points.forEach((point, index) => {
            expect(point === null || point === void 0 ? void 0 : point.x).toBeCloseTo(timeRange[index]);
            expect(point === null || point === void 0 ? void 0 : point.y).toBeCloseTo(expectedPoints[index]);
        });
    });
    it('Should calculate the points for a stable response (s^2 + 3s + 4)/(2s^3 + 5s^2 + 6s + 8)', () => {
        ...
        points.forEach((point, index) => {
            expect(point === null || point === void 0 ? void 0 : point.x).toBeCloseTo(timeRange[index], 1);
            expect(point === null || point === void 0 ? void 0 : point.y).toBeCloseTo(expectedPoints[index], 1);
        });
    });
