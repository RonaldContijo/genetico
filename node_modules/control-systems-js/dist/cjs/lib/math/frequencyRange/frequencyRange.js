...
exports.FrequencyRange = void 0;
const complex_1 = require("../complex");
const RANGE_FACTOR = 10;
const NUM_OF_SAMPLES = 1000;
const EPSILON = 10e-5;
class FrequencyRange {
    getDefault(poles, zeros, rangeFactor = RANGE_FACTOR, numOfSamples = NUM_OF_SAMPLES) {
        const features = [...poles, ...zeros];
        const minFeature = Math.min(...features.map((f) => (0, complex_1.abs)(f)));
        const maxFeature = Math.max(...features.map((f) => (0, complex_1.abs)(f)));
        ...
        const omega = new Array(numOfSamples);
...
//# sourceMappingURL=../../../../../src/lib/math/frequencyRange/frequencyRange.js.map