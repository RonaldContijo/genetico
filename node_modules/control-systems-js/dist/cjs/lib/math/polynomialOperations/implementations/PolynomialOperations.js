...
exports.PolynomialOperations = void 0;
...
class PolynomialOperations {
     ...
     * @param pol2
     */
    getHighestPolynomialOrder(pol1, pol2) {
    ...
    add(pol1, pol2) {
        ...
        for (const index of (0, range_1.range)(polynomialHighestOrder)) {
            const coefficient = (0, complex_1.add)(orderedPol1[index] || 0, orderedPol2[index] || 0);
    ...
    subtract(pol1, pol2) {
        ...
        const resultPolynomial = [];
        for (const index of (0, range_1.range)(polynomialHighestOrder)) {
            const coefficient = (0, complex_1.subtract)(orderedPol1[index] || 0, orderedPol2[index] || 0);
            resultPolynomial.push(coefficient);
        }
        return this.reversePolynomial(resultPolynomial);
    }
    multiply(pol1, pol2) {
        ...
        const result = Array(newPolSize).fill({ re: 0, im: 0 });
        for (const i of (0, range_1.range)(polSize1)) {
            for (const j of (0, range_1.range)(polSize2)) {
                result[i + j] = (0, complex_1.add)(result[i + j], (0, complex_1.multiply)(orderedPol1[i], orderedPol2[j]));
            }
        }
        return this.reversePolynomial(result);
    }
...
exports.PolynomialOperations = PolynomialOperations;
//# sourceMappingURL=../../../../../../src/lib/math/polynomialOperations/implementations/PolynomialOperations.js.map