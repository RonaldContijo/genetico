...
(0, vitest_1.describe)('Step class', () => {
    ...
    (0, vitest_1.beforeEach)(() => {
        ...
        step = new step_1.Step(calculateTf, inverseLaplace, convolution);
    });
    (0, vitest_1.it)('Should calculate the points for a stable response (s + 2)/(2s + 1)', () => {
        ...
        points.forEach((point, index) => {
            (0, vitest_1.expect)(point === null || point === void 0 ? void 0 : point.x).toBeCloseTo(timeRange[index]);
            (0, vitest_1.expect)(point === null || point === void 0 ? void 0 : point.y).toBeCloseTo(expectedPoints[index]);
        });
    });
    ...
    (0, vitest_1.it)('Should calculate the points for a stable response (s + 3)/(s^3 + 3s^2 + 5s + 1)', () => {
        ...
        const points = step.calculatePoints(tf, timeRange);
        (0, vitest_1.expect)(points[0].x).toBe(5.1);
        (0, vitest_1.expect)(points[0].y).toBeCloseTo(2.0057);
    });
    (0, vitest_1.it)('Should calculate the points for an unstable response (1)/(-2s^2 + s + 1)', () => {
        const timeRange = [1];
        const tf = {
            numerator: [(0, complex_1.complex)(1, 0)],
            denominator: [(0, complex_1.complex)(-2, 0), (0, complex_1.complex)(1, 0), (0, complex_1.complex)(1, 0)],
        };
        const points = step.calculatePoints(tf, timeRange);
        (0, vitest_1.expect)(points[0].x).toBe(1);
        (0, vitest_1.expect)(points[0].y).toBeCloseTo(-0.31044);
    });
});
//# sourceMappingURL=../../../../src/lib/step/step.spec.js.map