...
function algoritmoGenetico(
    ...
    */
    ...
    function calculateFitness(mochilaMochila) {
        ...
        //problema dos duplicados resolvido 
        if (temNumerosRepetidos(mochila)) {
            //esse if nunca será eecutado
        ...
        if (peso > MAX_WEIGHT) {
            ...
            return mochilaMochila.value * (MAX_WEIGHT/(mochilaMochila.totalWeight)*MAX_WEIGHT/(mochilaMochila.totalWeight)*MAX_WEIGHT/(mochilaMochila.totalWeight));
        }
        //penalizar mochilas não completas
        //isso não foi uma boa ideia, incrivel como o sistema enlouquece assim
       ...
       /*
        if (mochilaMochila.totalWeight / MAX_WEIGHT <= 0.8) {
            console.log('Mochila nao completa');
    ...
    function crossover(parent1, parent2) {
        ...
        do {
            ...
            filho1 = parent1.ListaDeItens.slice();
            filho2 = parent2.ListaDeItens.slice();
            //console.log("===========FILHO1==========");
            //console.log(...filho1);
            ...
            //console.log(...filho1);
            //console.log(...filho2);
            repetidos1 = temNumerosRepetidos(filho1);
            repetidos2 = temNumerosRepetidos(filho2);

            //console.log(`Tem repetidos ${repetidos1} ${repetidos2}`);
            if(impossivel>=20){
                //console.log('Impossivel');
                return[parent1.ListaDeItens.slice(),parent2.ListaDeItens.slice()];
            }
        } while (repetidos1 || repetidos2);
    ...
    for (generation; generation < MAX_GENERATIONS; generation++) {
        ...
        while (newPopulation.length < POPULATION_SIZE) {
            ...
            */
            ...
            console.log("Tentativa de cruzamento");
...
function uptadePesoMaimoMochila() {
